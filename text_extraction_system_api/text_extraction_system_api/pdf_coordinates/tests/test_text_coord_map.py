...
from text_extraction_system_api.pdf_coordinates.pdf_coords_common import Dir
from text_extraction_system_api.pdf_coordinates.text_coord_map import TextCoordMap
